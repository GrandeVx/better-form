...
import { FrameworkCard, FrameworkGrid } from '../components/FrameworkCard'
...
<FrameworkGrid>
  <FrameworkCard icon="nextjs" name="Next.js" href="/getting-started/nextjs" />
  <FrameworkCard icon="react" name="React" href="/getting-started/react" />
  <FrameworkCard icon="remix" name="Remix" href="/getting-started/remix" />
  <FrameworkCard icon="astro" name="Astro" href="/getting-started/astro" badge="React islands" />
</FrameworkGrid>
